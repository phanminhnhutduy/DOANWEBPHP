...
Route::get('/insert-delivery','DeliveryController@insert_delivery');//?
Route::post('/insert-delivery','DeliveryController@insert_delivery');

Route::get('/select-feeship','DeliveryController@select_feeship');//?
Route::post('/select-feeship','DeliveryController@select_feeship');

Route::get('/update-delivery','DeliveryController@update_delivery');//?
